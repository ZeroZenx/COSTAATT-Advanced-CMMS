...
// import { useMicrosoftAuth } from '../../contexts/MicrosoftAuthContext'; // Temporarily disabled
...
export default function LoginPage() {
  ...
  const { login } = useAuth();
  // const { isMicrosoftAuthEnabled, loginWithMicrosoft, isMicrosoftLoggedIn } = useMicrosoftAuth(); // Temporarily disabled
